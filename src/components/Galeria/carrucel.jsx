                        ...
                        <div className=" d-flex align-items-center col-lg-6 col-xs-12 ">
                            {producto.imagen.length > 0 && (
                                <Carousel className='carousel-container'>
                                    {producto.imagen.slice(0, 3).map((img, index) => (
                                        <Carousel.Item key={index} className='carousel-item carouselgal-item'>
                                            <img src={img} className="d-block" alt={`Cuchillos ${index + 1}`} />
                                        </Carousel.Item>))}
                                </Carousel>)}
                        </div>
